    ...
    return (
        <SafeAreaView style={tw`flex-1 bg-white`}>
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                {/* Trust Badges - 4 Grid Layout */}
                <View style={tw`mx-4 mt-6 mb-6 flex-row justify-between bg-gray-50 rounded-2xl border border-gray-100 p-4`}>
                    {/* Fast Delivery */}
                    <View style={tw`items-center gap-1.5 flex-1`}>
                        <Truck size={18} color="#0A8A3A" />
                        <Text style={tw`text-[9px] font-bold text-gray-950`}>Fast Delivery</Text>
                        <Text style={tw`text-[8px] text-gray-500 text-center leading-3`}>Get your order{'\n'}in no time</Text>
                    </View>
                    ...
                    <View style={tw`items-center gap-1.5 flex-1`}>
                        ...
                        <Text style={tw`text-[9px] font-bold text-gray-950`}>Best Prices</Text>
                        <Text style={tw`text-[8px] text-gray-500 text-center leading-3`}>Enjoy amazing{'\n'}deals daily</Text>
                    </View>
                    ...
                    <View style={tw`items-center gap-1.5 flex-1`}>
                        ...
                        <Text style={tw`text-[9px] font-bold text-gray-950`}>Secure Payment</Text>
                        <Text style={tw`text-[8px] text-gray-500 text-center leading-3`}>100% secure{'\n'}transactions</Text>
                    </View>
                    ...
                    <View style={tw`items-center gap-1.5 flex-1`}>
                        ...
                        <Text style={tw`text-[9px] font-bold text-gray-950`}>Live Support</Text>
                        <Text style={tw`text-[8px] text-gray-500 text-center leading-3`}>We're here to{'\n'}help you</Text>
                    </View>
                </View>
